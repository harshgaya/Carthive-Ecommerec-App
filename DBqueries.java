...
import com.harsh.cityfusion.Adapter.CategoryAdapter;
import com.harsh.cityfusion.Adapter.HomePageAdapter;
import com.harsh.cityfusion.Adapter.MyOrderAdapter;
import com.harsh.cityfusion.Model.AddressesModel;
import com.harsh.cityfusion.Model.CartItemModel;
import com.harsh.cityfusion.Model.CategoryModel;
import com.harsh.cityfusion.Model.HomePageModel;
import com.harsh.cityfusion.Model.HorizontalProductScrollModel;
import com.harsh.cityfusion.Model.MyOrderItemModel;
import com.harsh.cityfusion.Model.RewardModel;
...
//    private static ListenerRegistration registration;
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("CATEGORIES").collection("CATEGORIES").orderBy("index").get()
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("CATEGORIES").collection("CATEGORIES")
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_DATA").collection("USER_DATA").document("MY_WISHLIST")
                            ...
                            if (task.isSuccessful()) {
                                for (long x = 0; x < (long) task.getResult().get("list_size"); x++) {
                                    ...
                                    if (loadProductData) {
                                        ...
                                        firebaseFirestore.collection(Selectedcity).document("PRODUCTS").collection("PRODUCTS").document(productId)
                                                .get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                            @Override
                                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    FirebaseFirestore.getInstance().collection(Selectedcity).document("PRODUCTS").collection("PRODUCTS").document(productId).collection("QUANTITY").orderBy("time", Query.Direction.DESCENDING).get()
                                                            .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                                                @Override
                                                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                                    if (task.isSuccessful()) {
    ...
    public static void removeFromWishlist(final int index, final Context context) {
        ...
        final Map<String, Object> updateWishlist = new HashMap<>();
                    ...
                    firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_DATA").collection("USER_DATA").document("MY_WISHLIST")
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (ProductDetailsActivity.addToWishlistBtn != null) {
                                    ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(context.getColorStateList(R.color.colorPrimary));
                                }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (!ProductDetailsActivity.running_rating_query) {
                        ...
                        myRatedIds.clear();
                        myRating.clear();
                        firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_DATA").collection("USER_DATA").document("MY_RATINGS")
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_DATA").collection("USER_DATA").document("MY_CART")
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_DATA").collection("USER_DATA").document("MY_ADDRESSES")
    ...
    public static void loadRewards(final Context context, final Dialog loadingDialog, final Boolean onRewardsFragment) {
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document(FirebaseAuth.getInstance().getUid())
                            ...
                            .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_REWARDS").collection("USER_REWARDS")
        ...
        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_ORDERS").collection("USER_ORDERS").orderBy("time", Query.Direction.DESCENDING).get()
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        for (DocumentSnapshot documentSnapshot : task.getResult().getDocuments()) {
                                            firebaseFirestore.collection(Selectedcity).document("ORDERS").collection("ORDERS").document(documentSnapshot.getString("order_id")).collection("OrderItems").get()
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                for (final DocumentSnapshot orderItems : task.getResult().getDocuments()) {
                                                                    MyOrderItemModel myOrderItemModel = new MyOrderItemModel(orderItems.getString("Product Id"), orderItems.getString("Order Status"), orderItems.getString("Address"),
