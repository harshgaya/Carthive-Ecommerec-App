...
import com.harsh.cityfusion.Adapter.WishlistAdapter;
                    ...
                    FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                FirebaseFirestore.getInstance().collection(Selectedcity).document("PRODUCTS").collection("PRODUCTS").whereArrayContains("tags", tag)
