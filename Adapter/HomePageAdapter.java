...
import com.harsh.cityfusion.RequestBookActivity;
import com.harsh.cityfusion.ViewAllActivity;
                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (final HorizontalProductScrollModel model : horizontalProductScrollModelList) {
                            ...
                            if (!model.getProductID().isEmpty() && model.getProductTitle().isEmpty()) {
                                ...
                                firebaseFirestore.collection(Selectedcity).document("PRODUCTS").collection("PRODUCTS")
