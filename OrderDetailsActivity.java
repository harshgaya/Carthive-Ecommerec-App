                    ...
                    FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                final DocumentReference documentReference = FirebaseFirestore.getInstance().collection(Selectedcity).document("PRODUCTS").collection("PRODUCTS").document(model.getProductId());
                                ...
                                FirebaseFirestore.getInstance().runTransaction(new Transaction.Function<Object>() {
                                    ...
                                    public void onSuccess(Object object) {
                                        ...
                                        FirebaseFirestore.getInstance().collection(Selectedcity).document("USERS").collection(FirebaseAuth.getInstance().getUid()).document("USER_DATA").collection("USER_DATA").document("MY_RATINGS")
                    ...
                    public void onClick(View view) {
                        ...
                        cancelDialog.findViewById(R.id.yes_btn).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                map.put("Order Id", model.getProductId());
                                ...
                                FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            FirebaseFirestore.getInstance().collection(Selectedcity).document("CANCELLED ORDERS").collection("CANCELLED ORDERS").document().set(map)
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                FirebaseFirestore.getInstance().collection(Selectedcity).document("ORDERS").collection("ORDERS").document(model.getOrderID()).collection("OrderItems").document(model.getProductId()).update("Cancellation requested", true)
